...
export const NETWORK_ROWS: NetworkRow[][] = [
  [
    ...
    {
      name: "Abd Al Hadi Nahleh",
      countries: "Jordan",
      involvements: ["Participant"],
    ...
    },
    {
      ...
      countries: "Egypt",
      involvements: ["Expert"],
      disciplines: "Cultural Policies",
    },
    {
      name: "Yara Bou Nassar",
      countries: "Lebanon",
      involvements: ["Featured Artist"],
      disciplines: "Performing Arts",
    },
    {
      name: "Farah Saleh",
      countries: "Palestine, United Kingdom",
      involvements: ["Grantee"],
      disciplines: "Performing Arts",
    },
    {
    ...
    {
      name: "Nujoom Alghanem",
      countries: "United Arab Emirates",
      involvements: ["Grantee"],
      disciplines: "Cinema",
    },
    {
      name: "Hussein M. Elwan",
      countries: "Egypt, Netherlands",
      involvements: ["Participant"],
      disciplines: "Literature",
    },
    {
      name: "Mohamed Elmesrati",
      countries: "Libya, United Kingdom",
      involvements: ["Grantee"],
      disciplines: "Literature",
    },
  ],
  [
    ...
    {
      name: "Takween Cultural Club",
      countries: "Yemen",
      involvements: ["Participant"],
      disciplines: "Cultural Management",
    },
    {
      name: "Mazg for Culture and Arts",
      countries: "Egypt",
      involvements: ["Grantee"],
      disciplines: "Visual Arts",
    },
    {
      name: "Methrah for Arts and Culture",
      countries: "Jordan",
      involvements: ["Participant"],
      disciplines: "Performing Arts",
    },
    {
      name: "IRAB – Arab Association for Music",
      countries: "Lebanon",
      involvements: ["Grantee"],
      disciplines: "Music",
    },
    {
      name: "Warche 13 Art & Civic Space",
      countries: "Lebanon",
      involvements: ["Participant"],
      disciplines: "Visual Arts",
    },
    {
      name: "Ishbilia for Arts Association",
      countries: "Lebanon",
      involvements: ["Grantee"],
      disciplines: "Performing Arts",
    },
    ...
    {
      name: "Palestine Writing Workshop",
      countries: "Palestine",
      involvements: ["Grantee"],
      disciplines: "Literature",
    },
